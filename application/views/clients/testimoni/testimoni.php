			...
			<div class="carousel-inner">
				<div class="item active">
                  ...
                  <img class="media-object img-rounded img-responsive" src="http://placehold.it/100"> 
                      ...
                      This is a testimonial window. Feedback of user can be displayed here.
                    </p>
										<blockquote class="adjust2">
											<p>Abhijit Goswami</p>
											<small>
												<cite title="Source Title">
                          <i class="glyphicon glyphicon-globe"></i> www.example1.com
                        </cite>
											</small>
										</blockquote>
									</div>
								...
								<div class="col-md-10 col-sm-10 col-xs-12">
									<div class="caption">
										...
										<blockquote class="adjust2">
											...
											<small>
												<cite title="Source Title">
													<i class="glyphicon glyphicon-globe"></i> www.example2.com</cite>
											</small>
										</blockquote>
									</div>
								</div>
